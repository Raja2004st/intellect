...
const NomineesLeadershipStylePage = ({
  ...
  items = [
    ...
    },
    {
      ...
      color: "#20c6a2",
      badgePosition: "top",
      pillText: "Too task focused and less relationship\noriented – 3 respondents",
      pillColor: "#20c6a2",
    },
    {
      percent: 2,
      color: "#3a9ad9",
      badgePosition: "top",
      pillText: "Too relationship oriented and less\ntask oriented – 1 Respondent",
      pillColor: "#3a9ad9",
    },
  ],
  adjectivesTitle =
    "Description of Workplace Culture - Frequently Mentioned Adjectives",
  ...
  footnote =
    "* This excludes self feedback ; The larger fonts indicate more number of responses",
}) => {
  const blocks = useMemo(() => {
    const out = [];

    out.push(
      <FeedbackCommonHeader key="nls-hdr" title={title} className="nls-header" />,
    );
